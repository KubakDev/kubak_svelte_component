<script lang="ts">
	import type { NewsModel } from '$lib/models/newsModel';
	import { onMount } from 'svelte';
	import Carousel from '$lib/components/CustomCarousels/Carousel.svelte';
	export let news: NewsModel | undefined;
	onMount(() => {
		console.log('package: ', news);
	});
</script>
	...
	{#if news}
		{#if news.imagesCarousel}
			<Carousel
				...
				slideClass="p-0 w-full h-80 md:h-96  lg:h-[34rem]   2xl:h-140"
